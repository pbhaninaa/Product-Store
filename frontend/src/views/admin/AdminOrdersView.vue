      ...
      <v-col cols="12">
          <v-card class="admin-card pa-4 pa-sm-6" elevation="3" rounded="xl">
            ...
            <p class="text-caption text--secondary mb-4">
              ...
              <strong>Salon → Bookings</strong>. Totals and line prices are calculated on the server. For
              <strong>EFT</strong>, customers upload proof after paying; if the reference does not auto-match, use
              <strong>Confirm EFT received</strong> only after you verify their transfer. Customers cannot edit orders
              from the app.
            </p>
              ...
              >
                <v-expansion-panel-header class="order-panel-header">
                  <div class="d-flex flex-column flex-sm-row align-start align-sm-center flex-grow-1 pr-2">
                    <div>
                      <div class="font-weight-bold text-subtitle-1">
                        ...
                        <span class="text-caption text--secondary font-weight-regular ml-2">
                          {{ formatWhen(o.created_at || o.createdAt) }}
                        </span>
                      </div>
                    ...
                    <div class="d-flex flex-wrap align-center mt-2 mt-sm-0">
                      ...
                      <v-chip small outlined class="mr-2 mb-1 text-none">
                        {{ (o.payment_method || o.paymentMethod) === 'eft' ? 'EFT' : 'Cash in store' }}
                      </v-chip>
                      <v-chip
                      ...
                      <template v-else>
                        <v-chip
                          ...
                          :color="orderIsPaid(o) ? 'success' : 'warning'"
                        >
                          {{ orderIsPaid(o) ? 'Paid' : 'Pending' }}
                        </v-chip>
                        <v-chip
                          small
                          outlined
                ...
                <v-expansion-panel-content class="order-panel-body">
                  ...
                  <div class="d-flex flex-wrap align-center mt-4">
                    ...
                    <v-btn
                      v-if="showMerchantConfirmOrderPayment(o)"
                      small
                      depressed
                      color="success"
                  ...
                  <v-divider v-if="!orderIsPaid(o)" class="my-4" />

                  <div v-if="orderIsStrictlyPending(o)" class="d-flex flex-wrap align-center">
                    <p class="text-caption text--secondary mb-2 mb-sm-0 mr-sm-4 flex-grow-1">
                      Permanently removes this pending order and its lines. Only available while payment is still
                      pending.
                    </p>
                    <v-btn
                      small
